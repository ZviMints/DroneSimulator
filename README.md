...
- Inside "Drone.Drone" we have path to our image represents the drone itself.
After setting this up it is ready to launch.

## Sensors
- simulator.Lidar - check the distance between his spot forward and return the distance if hit, if not return 300 as max sample enabled.
...
- Directed simulator.Graph feature added. (JGrapht library required)
